...
if (result.records[0].allowance !== 4000 || result.records[0].advancePayment !== 3000 || result.records[0].note !== '1500 اضافي') throw new Error('خطأ في الصرفة/السحبية/الإضافي');
