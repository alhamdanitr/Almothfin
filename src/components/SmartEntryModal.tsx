...
export function SmartEntryModal({ onClose }: SmartEntryModalProps) {
  ...
  return <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm" dir="rtl">
    <div className="w-full max-w-3xl bg-slate-50 dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] border border-sky-200/70 dark:border-slate-700">
