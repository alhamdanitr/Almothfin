...
export default function Statements() {
  ...
  const statementData = useMemo(() => {
    if (!worker || !selectedMonth) return null;
  ...
  return (
    <div className="space-y-6">
      ...
      {statementData ? (
        <div ref={printRef} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 print:block print:space-y-6 print:text-black print:bg-white print:p-8" dir="rtl">
          ...
          <div className="hidden print:flex flex-col items-center justify-center border-b-2 border-gray-800 pb-6 mb-6">
            ...
            <div className="flex items-center gap-4 mt-4 text-gray-600 font-medium">
              <span className="bg-gray-50 px-4 py-1 rounded-md border border-gray-200">عن شهر: <span className="font-bold text-gray-900">{selectedMonth}</span></span>
          ...
          <div className="bg-white dark:bg-slate-800 shadow-sm rounded-2xl border border-gray-100 dark:border-slate-700 overflow-hidden print:shadow-none print:border-gray-300 print:rounded-lg">
            <div className="px-6 py-4 border-b border-gray-100 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-900/20 print:bg-gray-100 print:border-gray-300">
              <h3 className="font-semibold text-gray-900 dark:text-white print:text-gray-900">تفاصيل الحركات اليومية</h3>
            </div>
        ...
        <div className="text-center py-12 text-gray-500 dark:text-gray-400 print:hidden">
          يرجى تحديد العامل والشهر لعرض كشف الحساب
        </div>
      )}
